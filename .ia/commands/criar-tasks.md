...
- PRD requerido: `tasks-ia/[nome-funcionalidade]/prd.md`
- Tech Spec requerido: `tasks-ia/[nome-funcionalidade]/techspec.md`
...
- Pasta da funcionalidade: `./tasks-ia/[nome-funcionalidade]/`
- **Subpasta obrigatória**: `./tasks-ia/[nome-funcionalidade]/tasks/`
- Template para a lista de tarefas: `./.ia/templates/tasks-template.md`
- Lista de tarefas: `./tasks-ia/[nome-funcionalidade]/tasks/tasks.md`
- Template para cada tarefa individual: `./.ia/templates/task-template.md`
- Tarefas individuais: `./tasks-ia/[nome-funcionalidade]/tasks/[num]_task.md`

### Formato do Resumo de Tarefas (tasks.md)

- **SEGUIR ESTRITAMENTE O TEMPLATE EM `./.ia/templates/tasks-template.md`**

### Formato de Tarefa Individual ([num]_task.md)

- **SEGUIR ESTRITAMENTE O TEMPLATE EM `./.ia/templates/task-template.md`**
