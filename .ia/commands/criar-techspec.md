...
- Template Tech Spec: @.ia/templates/techspec-template.md
- PRD requerido: `tasks-ia/[nome-funcionalidade]/prd.md`
- Documento de saída: `tasks-ia/[nome-funcionalidade]/techspec.md`

## Pré-requisitos

- Revisar padrões do projeto em @.ia/rules
- Confirmar que o PRD existe em `tasks-ia/[nome-funcionalidade]/prd.md`
...
- Mapear decisões para @.ia/rules
- Destacar desvios com justificativa e alternativas conformes

### 5. Gerar Tech Spec (Obrigatório)

- Usar @.ia/templates/techspec-template.md como estrutura exata
...
- Salvar como: `tasks-ia/[nome-funcionalidade]/techspec.md`
...
- [ ] Verificou as rules em @.ia/rules
- [ ] Arquivo escrito em `./tasks-ia/[nome-funcionalidade]/techspec.md`
