...
- Template fonte: @.ia/templates/prd-template.md
- Nome do arquivo final: `prd.md`
- Diretório final: `./tasks-ia/[nome-funcionalidade]/` (nome em kebab-case)
...
- Use o template `.ia/templates/prd-template.md`
...
- Crie o diretório: `./tasks-ia/[nome-funcionalidade]/`
- Salve o PRD em: `./tasks-ia/[nome-funcionalidade]/prd.md`
...
- [ ] Arquivo salvo em `./tasks-ia/[nome-funcionalidade]/prd.md`
